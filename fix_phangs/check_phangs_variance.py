...
{GALID}_mask.fits masked spaxels, and requires finite DATA of either sign for
spectral STAT-gap selection. Joint DATA/STAT NaNs are grouped into 8-connected
components on each wavelength plane. A component is spatially fillable only
when its full adjacent boundary has finite DATA and positive finite STAT. The
log is replaced
